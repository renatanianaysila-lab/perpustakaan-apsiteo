{{-- resources/views/admin/rak/edit.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Edit Rak - Sistem Perpustakaan</title>
...
<div class="flex min-h-screen">
    ...
    <main class="ml-64 flex-1 p-8">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-slate-800 mt-2">Edit Rak</h2>
            <p class="text-sm text-slate-500">Perbarui data rak <span class="font-medium">{{ $rak->nama_rak }}</span>.</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-100 max-w-2xl">
            <form method="POST" action="{{ route('admin.rak.update', $rak->id_rak) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="lokasi_rak" value="{{ old('lokasi_rak', $rak->lokasi_rak) }}"
                           class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-200">
                </div>
