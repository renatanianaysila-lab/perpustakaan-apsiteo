...
<div class="flex min-h-screen">
    ...
    <main class="ml-64 flex-1 p-8">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-slate-800 mt-2">Tambah Anggota Baru</h2>
            <p class="text-sm text-slate-500">Mendaftarkan anggota akan otomatis membuat akun login &amp; Kartu Anggota Digital.</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.anggota.store') }}" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="id_anggota" value="{{ old('id_anggota') }}" placeholder="AG-001"
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2"
                              class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-200">{{ old('alamat') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telepon" value="{{ old('no_telepon') }}" placeholder="0812-3456-7890"
                               class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-200">
                    </div>
                </div>

                <div class="border-t border-slate-100 pt-5">
                    <p class="text-sm font-semibold text-slate-700 mb-3">Akun Login</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit" class="px-5 py-2.5 bg-blue-900 hover:bg-blue-950 text-white text-sm font-medium rounded-lg transition">Daftarkan Anggota</button>
